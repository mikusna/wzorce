...
namespace SingletonVault
{
    sealed class Vault
    {
        ...
        public int GenerateKey()
        {
            ...
            {
                //zwróć istniejący klucz, jeśli już został wygenerowany
                return _accessKey.Value;
            }
            _accessKey = CreateKey(100, 100000);//generowanie klucza
            _keyAccessed = true;//flaga że klucz został wygenerowany
